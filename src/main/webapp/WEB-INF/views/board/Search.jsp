	...
	<div class="container">
		<div class="panel panel-info">
			...
			<div class="panel-body">
				...
				<div align="center">
					<ul class="pagination">
						<li><a href="/board/Search?currentpage=${pagingData.prev_pageno}&searchWord=${searchWord}&keyword=${keyword}" >«</a></li>
						<c:if test="${pagingData.page_sno > 0}">
							<c:forEach var="iter" begin="${pagingData.page_sno}" end="${pagingData.page_eno}">
							<li id="pagination${list}"><a href="/board/Search?currentpage=${iter}&searchWord=${searchWord}&keyword=${keyword}" ><b>${iter}</b></a></li>
							</c:forEach>
						</c:if>
						<li><a href="/board/Search?currentpage=${pagingData.next_pageno}&searchWord=${searchWord}&keyword=${keyword}">»</a></li>
					</ul>
				</div>
